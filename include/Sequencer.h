...
enum {
  SEQ_STATE_IDLE = 0,
  SEQ_STATE_WAIT_POLL_CYCLE,
  SEQ_STATE_WAIT_BEFORE_F6,
  SEQ_STATE_WAIT_F6_TIMER,
  SEQ_STATE_WAIT_KEYPAD_RESPONSE,
  SEQ_STATE_WAIT_ACK_COMMAND,
  SEQ_STATE_FINISH_UP,
  SEQ_CHECK_DISPLAY_REQUEST,
  SEQ_WAIT_BEFORE_F7,
  SEQ_WAIT_INIT_COMMAND,
  SEQ_WAIT_FOR_F7_SENT,
...
typedef void (*keypad_callback)(uint8_t record_type, uint8_t keypad_addr, uint8_t record_data_length,
